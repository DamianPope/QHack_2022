...
def compute_entanglement(theta):
    ...
    #Circuit for entangled state without tardigrade
    ...
    #circuit for entangled state with tardigrade
    ...
    return second_renyi_entropy(circuitOne()),second_renyi_entropy(circuitTwo())
